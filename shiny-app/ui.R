# ui.R
# Author: Chamika H Senanayake
# Date: 21-NOV-2020
# Description: Shiny UI, Coursera Data Science Capstone Final Project
# GitHub: https://github.com/ChamikaRproj/DataScience-Capstone
    ...
    navbarPage("Next Word Predict",
               ...
               tabPanel("About",
                        ...
                        div("Next Word Predict is a Shiny app that uses a text
                            ...
                            a(target = "_blank", href = "https://github.com/ChamikaRproj/DataScience-Capstone/shiny-app/",
                              "Next Word Predict")),
                        br(),
                        h3("About Me"),
                        br(),
                        div("My name is Dr. C H Senanayake and I am a
                            Medical Officer in Health Informatics",
                            a(target = "_blank", href = "https://pgim.cmb.ac.lk", "PGIM"),".",
                            "I'm a medical officer in Health Informatics",
                            br(),
                            br(),
                            "I'm a Trainee in MD Health Informatics at Postgraduate Institute of Medicine, University of Colombo",
                            br())
               )
    )
)